...
class Command(BaseCommand):
    help = "Rotate one explicitly registered encrypted-field target."

    def add_arguments(self, parser):
        parser.add_argument("--target", required=True)
        parser.add_argument("--from-key-id")
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            active_key_id = get_active_field_key().key_version
            checkpoint_path = (
            ...
            while True:
                ...
                result = run_rotation(
                    ...
                    from_key_id=options["from_key_id"],
                )
        ...
        self.stdout.write(
            f"rotation_status=ok mode={mode} scanned={result.scanned} written={result.written} "
